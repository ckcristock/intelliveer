...
export class GlobalRoutesService {
	...
	private urlCoorWithProsp: string =
		'/dashboard/home/add-patient/coor-with-prospect';
	...
	private urlPracticeInsuranceGroup: string =
	...
	private routesPracticeToolInsurance: any[] = [
		...
		{
			title: 'Fee Schedules',
			url: `${this.urlPracticeInsurance}/manage-roleeee`,
			isEnabled: true,
			value: '',
			child: [
				{
	...
	private routesPracticeToolInsuranceGroupAdd: any[] = [
		{
	...
	private routesPracticeToolInsuranceGroupEdit: any[] = [
		{
			title: 'Insurance Group Information',
			url: `${this.urlPracticeInsuranceGroup}/edit/insurance-group-information`,
			isEnabled: true,
			value: '',
			child: []
		},
		{
			title: 'Orthodontic Benefits',
			url: `${this.urlPracticeInsuranceGroup}/edit/orthodontic`,
			isEnabled: true,
			value: '',
			child: []
		},
		{
			title: 'Dental Benefits',
			url: `${this.urlPracticeInsuranceGroup}/edit/dental`,
			isEnabled: true,
			value: '',
			child: []
		}
	...
	getPracticeToolInsuranceGroupRoutes() {
		return this.routesPracticeToolInsuranceGroupAdd;
	}

	getPracticeToolInsuranceGroupRoutesEdit() {
		return this.routesPracticeToolInsuranceGroupEdit;
	}
}
