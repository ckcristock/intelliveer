...
const routes: Routes = [
	{
		...
		children: [
			...
			},
			{
				...
				loadChildren: () =>
					import(
						'@pages/onboarding/business-group/business-group.module'
			...
			},
			{
				...
				loadChildren: () =>
					import(
						'@pages/onboarding/legal-entity/legal-entity.module'
			...
			},
			{
				path: 'mapping',
				loadChildren: () =>
					import('@pages/onboarding/mapping/mapping.module').then(
						(m) => m.MappingModule
					),
			},
		],
