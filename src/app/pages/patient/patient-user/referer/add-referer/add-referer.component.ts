...
@Component({
  selector: 'app-add-referer',
  templateUrl: './add-referer.component.html',
  styleUrls: ['./add-referer.component.scss'],
})
export class AddRefererComponent implements OnInit, OnDestroy {
